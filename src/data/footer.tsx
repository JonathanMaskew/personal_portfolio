    ...
    modalChildren: (
      <>
        <div className="flex flex-col gap-10">
          ...
          <div>
            I put my full dedication into everything I do to achieve the best
            possible output. Everything I do is done with care and I put immense
            thought into every detail. Why should it be this way? How should it
            be done? How will this scale and adapt?
          </div>
          ...
          <ModalSection icon={LayoutDashboard} title="Layout">
            ...
            scrollable page that highlights various aspects of my
            accomplishments, providing a holistic view of me.
          </ModalSection>
          <ModalSection icon={Palette} title="Colors">
            ...
            intended to bring a sense of professionalism and helps the colors to
            pop.
          </ModalSection>
          <ModalSection icon={MousePointerClick} title="Interactivity">
            Little interactions and animations make the site feel friendly,
            engaging, and lively. Hovering over content makes it apparent what
            is interactable. Little animations when interacting provide clarity
            and a sense of flow.
          </ModalSection>
          ...
          <ModalSection icon={MonitorSmartphone} title="Responsiveness">
            I knew this site would likely be viewed on a variety of devices. In
            professional contexts, it may be viewed on desktop. However, in many
            instances, especially if sending a link, it may be viewed on a
            phone. Therefore, I built the site to not only be fully responsive,
            but to be optimized for mobile vs desktop viewing. For example, on
            desktop you get a sidebar for navigation and hover effects. On
            mobile, you get a top navigation bar.
          </ModalSection>
          <ModalSection icon={Code} title="Technology">
            ...
            with AI being used more as an assistant, rather than a developer.
          </ModalSection>
          <ModalSection icon={Construction} title="Never Complete">
            As various experiences continue to shape me, this site will continue
            to evolve.
          </ModalSection>
        </div>
      </>
  ...
  },
  {
    ...
    modalChildren: (
      <>
        <div className="flex flex-col gap-10">
          <div>
            I love to imagine the experience that others perceive, and building
            a personal brand allowed me to be creative in that sense.
          </div>
          <div>
            It all started when I discovered Google Sites. As a child, Google
            Sites was fascinating. I could build a website all on my own,
            without knowing how to code. Then, I could publish it for free. To
            me, this was amazing.
          </div>
          <div>
            Out of this fascination came J&apos;s Page. Initially, it began as a
            way for me to organize and share animations, videos, stories, and
            various other creative artifacts. It was essentially a mix of a
          ...
          <div>
            ...
            mirroring the J&rsquo;s branding, it was clear that I was building a
            personal brand. And what does a brand need? A logo.
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
            <Image
              src={jsCreations}
          ...
          <div>
            Eventually, as I continued to add content beyond just creations and
            animations, the branding needed to reflect this. At last, the
            J&rsquo;s brand was born.
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
            <Image
              src={jsGif}
          ...
          <div>
            More recently, I&apos;ve been exploring some new creative outlets,
            including logo design, graphic design, and UI design. With this, I
            decided to go back to my roots, and build myself a new logo.
          </div>
          ...
          <div>
            ...
            Engineering, where I now understand the powerful code behind these
            sites.
          </div>
          <div>
